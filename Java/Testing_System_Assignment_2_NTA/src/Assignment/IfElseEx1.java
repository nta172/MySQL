...
public class IfElseEx1 {
	public static void main(String[] args) {
		...
		if(acc2.department == null) {
			...
			System.out.println("Phòng ban nhân viên này là " + acc2.department.name);
		}
		...
		if(acc2.groups == null) {
			...
			if(countGroup == 1 || countGroup == 2) {
				System.out.println("Group của nhân viên này là Java Freser, C# Fresher");
			}
			if(countGroup == 3) {
				System.out.println("Nhân viên này là người quan trọng, thma gia nhiều group");
			}
			if(countGroup == 4) {
				System.out.println("Nhân viên này là người hóng chuyện, thma gia tất cả các group");
			}
		// Question 3 : Toán tử ternary
