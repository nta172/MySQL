...
public class ForEachEx1 {
	public static void main(String[] args) {
		...
		// Question ? in ra thông tin account 1 :
		String [] accounti = {acc1.email, acc1.fullName, acc1.department.name.toString()};
		
		for(String accounts : accounti) {
		...
		Department[] inforDept = {dep1, dep2, dep3};
		for (Department dept : inforDept) {
