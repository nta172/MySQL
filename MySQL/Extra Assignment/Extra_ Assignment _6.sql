...
VALUE						(	1		,	1		,	'2023-06-06'	, '2023-06-06'		,	'Làm đúng hạn'			),
							(	2		,	2		,	'2023-07-06'	, '2023-06-06'		,	'Làm trước hạn'			),
                            (	3		,	3		,	'2023-08-06'	, '2023-09-06'		,	'Làm quá hạn'			),
                            (	4		,	1		,	'2023-07-06'	, '2023-06-06'		,	'Làm trước hạn'			);

INSERT INTO Projects		 ( ManagerID , ProjectName 		, ProjectStartDate	, ProjectDescription	, ProjectDetail		, ProjectCompletedOn	)
VALUE						(	1		,'Java'				,	'2023-06-06'	, 'Làm đúng vào'		,'Làm đúng hạn'		,	'2023-08-06'		),
							(	2		,'C#'				,	'2023-07-06'	, 'Làm nhanh lên'		,'Làm trước hạn'	,	'2023-09-06'		),
                            (	3		,'Android'			,	'2023-08-06'	, 'Nộp trước ngày 17/3'	,'Làm quá hạn'		,	'2023-10-06'		),
                            (	1		,'C++'				,	'2023-07-06'	, 'Không biết đừng làm'	,'Làm trước hạn'	,	'2023-11-06'		);

INSERT INTO Work_Done		( EmployeeID, ModuleID	, WorkDoneDate	, WorkDoneDescription	, WorkDoneStatus	)
VALUE						(	1		,	1		,'2023-06-06'	, 'Làm được phết'		,		1			),
							(	2		,	2		,'2023-07-06'	, 'Làm ổn phết'			,		1			),
                            (	3		,	3		,'2023-08-06'	, 'Không biết làm'		,		0			),
                            (	1		,	4		,'2023-07-06'	, 'Không biết ko làm'	,		0			);
...
VALUE						(N'Nguyễn Hải'		,N'Đăng'			,'2023-06-06'		, 		1		,		1		,'SS001'				),
							(N'Lê Thị'			,N'Thư'				,'2023-07-06'		, 		1		,		1		,'SS002'				),
                            (N'Nguyễn Hữu'		,N'Thắng'			,'2023-08-06'		, 		1		,		2		,'SS003'				),
                            (N'Dương Văn'		,N'Hữu'				,'2023-07-06'		, 		0		,		2		,'SS004'				);